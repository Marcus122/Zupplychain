    ...
    function Class(postcode, radius, $postCode) {
        ...
        function loadWarehouseData(data) {
            ...
            if(data.height && data.height !== 'N/A'){
                ...
                if(resultsElem.find(".js-height").next('sup').length===0 && resultsElem.find(".js-height").next('.background').length===0) resultsElem.find(".js-height").after('<span class="background">m</span>')
            }else{
                data.height = 'N/A'
